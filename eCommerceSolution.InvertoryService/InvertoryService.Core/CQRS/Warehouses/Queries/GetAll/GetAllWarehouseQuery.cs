...
public class GetAllWarehouseQueryHandler(IWarehouseRepository warehouseRepository) : IQueryHandler<GetAllWarehouseQuery, IEnumerable<WarehouseResponse>>
{
    ...
    {
        var warehouses = await warehouseRepository.GetAllWithFilters(e => e.CreatedBy == query.UserId, ct);
